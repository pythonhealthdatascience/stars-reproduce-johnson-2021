...
# Load local package epicR (this simulates the use of library())
...
# CHANGE: Reduced from 50 million (50e+6/5e+7) / 100 million (1e+8)
settings$n_base_agents <- 100e+6
...
```{r save, echo=FALSE}
write.csv(s1NoCD, "mini_analysis.csv", row.names=FALSE)
```
