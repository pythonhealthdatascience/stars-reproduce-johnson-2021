...
## 12.25-12.30, 14.08-X: Fixing my mini analysis and returning to lower numbers of agents
...
As I'd tried before, ran:

* 5000 (5e3)
* 50,000 (5e4) (17 seconds)
* 500,000 (5e5) (2.6 minutes)
...
df_s1nocd = pd.concat([df5e3, df5e4, df5e5])
df_s1nocd
```
